  ...
  return (
    <div className="min-h-screen lg:h-screen bg-[#F4F9F8] relative flex items-center justify-center p-4 sm:p-6 lg:p-8 overflow-x-hidden lg:overflow-hidden selection:bg-[#2B7A75] selection:text-white">
      ...
      <motion.div
        ...
        className="w-full max-w-5xl bg-white rounded-3xl lg:rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col md:flex-row relative z-10 h-auto lg:h-[90vh] my-4 lg:my-0"
      >
        ...
        <div className="w-full md:w-7/12 p-6 sm:p-8 md:p-12 xl:p-16 bg-white relative flex flex-col justify-center h-auto lg:h-full overflow-y-auto">
          {/* Mobile Logo */}
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3.5 bg-gray-50 border rounded-xl outline-none transition-all text-gray-700
                      ${fieldError.identifier ? "border-red-300 focus:border-red-500 focus:ring-4 focus:ring-red-500/10" : "border-gray-200 focus:border-[#2B7A75] focus:bg-white focus:ring-4 focus:ring-[#2B7A75]/10 hover:border-gray-300"}`}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-3.5 bg-gray-50 border rounded-xl outline-none transition-all text-gray-700 font-medium
                      ${fieldError.password ? "border-red-300 focus:border-red-500 focus:ring-4 focus:ring-red-500/10" : "border-gray-200 focus:border-[#2B7A75] focus:bg-white focus:ring-4 focus:ring-[#2B7A75]/10 hover:border-gray-300"}`}
                  />
                  <button
                    type="button"
